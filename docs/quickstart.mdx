...
<Steps>
  <Step title="Add the package and peers">
    ...
    ```bash pnpm
    pnpm add react-native-super-calendar react-native-reanimated react-native-gesture-handler react-native-worklets @legendapp/list date-fns
    ```
    </CodeGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Modes" icon="table-cells" href="/guides/modes">
