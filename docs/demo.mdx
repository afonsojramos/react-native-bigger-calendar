...
This is the [`examples/native`](https://github.com/afonsojramos/react-native-super-calendar/tree/main/examples/native)
app exported for the web and hosted on GitHub Pages. Everything here runs the
real library.

<Frame>
  <iframe
    src="https://afonsojramos.github.io/react-native-super-calendar/"
    title="super-calendar web demo"
